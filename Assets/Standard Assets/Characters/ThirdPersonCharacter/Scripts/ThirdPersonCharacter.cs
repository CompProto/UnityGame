...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        int charges = 1; // The number of maximum charge charges! Lol
		...
		public void Move(Vector3 move, bool charge, bool jump)
		{
			...
			if (m_IsGrounded)
			{
				HandleGroundedMovement(false, jump); // replace with "crouch"
            }
			else
			{
			...
			ScaleCapsuleForCrouching(false); // replace with "crouch"
